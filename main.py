...
**🔬 SCIENCE / SPACE / R&D** (до 2 — физика, биотех, космос, значимые papers; СЮДА же — концептуально интересные «большие вопросы» про AI/CS: сознание и природа интеллекта, alignment-дебаты, глубокие научные/общественные следствия AI. НЕ сухие инкрементальные ML-статьи — те по-прежнему мимо)
